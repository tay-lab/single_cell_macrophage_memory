classdef Violinmed < handle
    ...
    methods
        function obj = Violinmed(data, pos, varargin)
...
%             end
%             obj.MedianPlot = scatter(pos, meanValue, [], [1 1 1], 'filled');   % this is to plot median
            obj.MedianPlot = scatter(pos, meanValue, [], [1 1 1], 'filled', 'MarkerEdgeColor', 'black', 'LineWidth', 1);   % To plot mean value as dot
